...
?>
   ...
   <a href='index.php?halaman=panen_masuk' class='btn btn-small btn-danger'>
   <span>Kembali </span>
   </a>
   <br/>
   <br/>
...
<div class='row-fluid sortable'>		
    ...
    <th>Total Harga</th>
						  ...
						  <tbody>
							<tr>
							<?php
		$pesan="SELECT * FROM hasil WHERE tgl_trans BETWEEN '$_POST[tgl_awal]' AND '$_POST[tgl_akhir]'";
	...
	$sum2="SELECT SUM(total) AS total_harga FROM hasil WHERE tgl_trans BETWEEN '$_POST[tgl_awal]' AND '$_POST[tgl_akhir]'";
