...
<div class='row-fluid sortable'>		
					...
					<div class='box-content'>
						<table class='table table-striped table-bordered bootstrap-datatable datatable'>
						  ...
						  <tbody>
							...
							<?php
		$qtmpil_barang="select * from barang inner join unit on barang.unit_id = unit.unit_id inner join kategori on barang.kategori_id=kategori.kategori_id inner join lokasi on barang.lokasi_id=lokasi.lokasi_id  ";						
        ...
        <!--   <td><?php echo "$row1[diskon]%"; ?></td>-->
          ...
          <td><center><?php echo "<a class='btn btn-mini btn-primary' href=coba2.php?halaman=form_ubah_data&kode=barang_update&id=$row1[inc]>"; ?>
