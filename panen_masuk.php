...
<form id="form1" name="form1" method="post" action="index.php?halaman=panen_masuk_cari">
...
<a href='form_hasil.php' class='btn btn-small btn-primary'> <i class="halflings-icon white plus"></i> <span>Tambah Data</span>
   </a>
   <br/>
   <br/>
<div class='row-fluid sortable'>		
				<div class='box span12'>
					<div class='box-header' data-original-title>
						<h2><i class='halflings-icon user'></i><span class='break'></span>Data Panen Masuk</h2>
						<div class='box-icon'>
    ...
    <th>Total Harga</th>
						  ...
						  <tbody>
							...
							<?php
		$pesan="SELECT * FROM hasil ORDER BY inc DESC LIMIT 25";
		...
		<tr><td><?php echo "$no"; ?></td>
           <td><a href="#" onclick="javascript:wincal=window.open('hasil_detail.php?id=<?php echo $row['hasil_id']; ?>','Lihat Data','width=790,height=400,scrollbars=1');">
    <?php echo $row['hasil_id']; ?></a>
    </td>
