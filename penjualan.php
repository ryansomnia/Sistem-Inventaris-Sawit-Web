...
<a href='form_jual.php' class='btn btn-small btn-primary'><i class="halflings-icon white plus"></i> <span>Tambah Data</span>
   </a>
   <br/>
   <br/>
<div class='row-fluid sortable'>		
				<div class='box span12'>
					<div class='box-header' data-original-title>
						<h2><i class='halflings-icon user'></i><span class='break'></span>Data Pemakaian</h2>
						<div class='box-icon'>
   ...
   <td align="right"><?php echo " "; echo digit($row['total']); ?></td>
   <!-- <td align="right"><?php echo "Rp "; echo digit($row['biaya_kirim']); ?></td>
    <td align="right"><?php echo "Rp "; echo digit($grand_total); ?></td>-->
	 <td><a class='btn btn-mini btn-info' href="#" onclick="javascript:wincal=window.open('print_nota.php?id=<?php echo $row['jual_id']; ?>','Lihat Data','width=700,height=400,scrollbars=1');">
