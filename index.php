...
//More information visit www.utamasolution.com
...
<!--END HEADER MENU ATAS -->		
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; <?php echo"$tahun";?> <a href="#" alt="<?php echo"$idn[nama_identitas]";?>"><?php echo"$idn[nama_identitas]";?></a></span>
