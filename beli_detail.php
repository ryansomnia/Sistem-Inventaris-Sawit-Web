...
<body>
  <a href="index.php?halaman=barang_masuk"><div id="keluar">Kembali</div></a>
<?php
	$warna1="#c0d3e2";
	$warna2="#cfdde7";
	$warna=$warna1;
	...
	$z=mysql_fetch_array(mysql_query("SELECT * FROM supplier WHERE supplier_id='$data[supplier_id]'"));
...
<table cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td id="noBorder">:</td>
    <td id="noBorder"><?php echo "$z[supplier_nama]"; ?></td>
  </tr>
